...
一个基于 **Python Flask** 构建的简易用户信息管理平台，提供用户登录认证、信息展示、搜索、头像上传、个人中心、充值、动态页面加载等功能。该项目专注于**安全性最佳实践**，适合作为 Flask 入门学习和安全编码参考。
...
user-management/
│
├── app.py                      # Flask 主应用（路由、认证、注册、搜索、上传、个人中心、充值、动态页面）
